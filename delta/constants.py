...
TRIANGLE_HEIGHT: float = math.sqrt(3) / 2
...
# Минимальная площадь базисного треугольника (Ternary mode),
# ниже которой выдаётся предупреждение о сниженной точности
MIN_TRIANGLE_AREA_WARNING = 0.001
...
ZORDER_GRID = 1
ZORDER_HATCH = 1.5  # Между сеткой и линиями
ZORDER_LINES = 2
ZORDER_COMPS = 5
ZORDER_MASK = 9
ZORDER_OVERLAY = 10
